            ...
            <div class="card-box mb-30">
                <div class="pd-20">
                    <div class="row">
                        ...
                        <div class="col-lg-1">
                        <a href="{{ url('/pemesanan/create') }}" type="button" class="btn btn-primary"> Create </a>
                        </div>
                    </div>
                </div>
                <div class="pb-20">
                        ...
                        <tbody>
                            @foreach ($datas as $data)
                                <tr>
                                    ...
                                    <td>
                                        {{\Carbon\Carbon::parse($data->product_care_date)->format('d-m-Y')}}
                                    </td>
                                    @php  
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                <a class="dropdown-item" href="{{ url('pemesanan/' . $data->id) }}">
