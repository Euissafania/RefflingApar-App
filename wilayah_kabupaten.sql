...
INSERT INTO `wilayah_kabupaten` (`id_kabupaten`, `id_provinsi`, `nama_kabupaten`) VALUES
...
ALTER TABLE `wilayah_kabupaten`
  ...
  ADD KEY `provinsi_id` (`id_provinsi`);
...
--
ALTER TABLE `wilayah_kabupaten`
  ADD CONSTRAINT `provinsi_id` FOREIGN KEY (`id_provinsi`) REFERENCES `wilayah_provinsi` (`id_provinsi`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
